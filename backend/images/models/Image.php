...
namespace backend\images\models;
...
use backend\images\ModuleTrait;
...
class Image extends \yii\db\ActiveRecord
{
    ...
    private function getStorage(){
        return Yii::$app->get('imageFactory');
    }


    private function isLocalStorage(){
        if($this->getStorage()->storage === 'local'){
            return true;
        }else{
            return false;
        }
    ...
    public function getUrl($size = false){
        ...
        if($this->isLocalStorage()){
            ...
            $url = $this->getStorage()->getUrl($newUrl);

            $filePath = (new \yii\db\Query())
                ->select(['filePath'])
                ->from('photos')
                ->where(['clinic_id' => $this->itemId,'filePath' => $newUrl])
                ->one();
    ...
    public function getPath($size = false){
        ...
        $newOrigin = $this->getStorage()->getUrl($origin);
